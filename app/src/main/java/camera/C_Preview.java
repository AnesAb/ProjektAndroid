...
class C_Preview extends ViewGroup implements SurfaceHolder.Callback {
    ...
    C_Preview(Context context, SurfaceView sv) {
        super(context);
...
//    	}
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        // The Surface has been created, acquire the kamera_knapp and tell it where
        // to draw.
        try {
            if (mCamera != null) {
